...
module.exports = async function(content) {
	...
	console.log('step 1')
	const permlink = steem.formatter.commentPermlink(process.env.STEEM_UN, 'twitter2steem');
	const operations = [
		['comment',
			{
				parent_author: '',
				parent_permlink: 'twitter2steem',  // first tag
				author: process.env.STEEM_UN,
				permlink,
				title: '',
				body: content,
	...
	console.log('step 3')
	// console.log(tx);
	return 'POSTED ' + tx.block_num + ` https://steemit.com/twitter2steem/@${process.env.STEEM_UN}/${permlink}`;
}
